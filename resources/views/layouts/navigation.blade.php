            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('flag')" :active="request()->routeIs('flag')">
                        <img src="{{ url('img/flag.png') }}" alt="" class="">
                    </x-nav-link>
                    <x-nav-link :href="route('wishlist')" :active="request()->routeIs('wishlist')">
                        <img src="{{ url('img/wishlist.png') }}" alt="" class="">
                    </x-nav-link>
                    <x-nav-link :href="route('dialog')" :active="request()->routeIs('dialog')">
                        <img src="{{ url('img/dialog.png') }}" alt="" class="">
                    </x-nav-link>
                </div>
            </div>
